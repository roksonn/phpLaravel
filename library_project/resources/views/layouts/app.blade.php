...
<body>
    ...
    <div id="menubar">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        <li ><a href="{{ route('dashboard') }}" >Panou de control</a></li>
                        <li><a href="{{ route('authors') }}" >Autori</a></li>
                        <li><a href="{{ route('publishers') }}" >Edituri</a></li>
                        <li><a href="{{ route('categories') }}" >Categorii</a></li>
                        <li><a href="{{ route('books') }}" >Cărți</a></li>
                        <li><a href="{{ route('students') }}" >Înregistrare studenți</a></li>
                        <li><a href="{{ route('book_issued') }}" >Închiriere cărți</a></li>
                        <li><a href="{{ route('reports.not_returned') }}" class="card-link">Raport</a></li>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span>  PAW : Achim Andrei, Butuza Calin, Petric Ovidiu, Todea Dorin</a></span>
                </div>
            </div>
        </div>
    </div>
